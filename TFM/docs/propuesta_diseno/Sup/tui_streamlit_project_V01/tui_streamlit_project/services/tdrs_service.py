...
SCENARIO_META = {
    "Popular": {"icon": "🔥", "description": "Prioriza volumen turístico y destinos con mayor popularidad."},
    "Equilibrado": {"icon": "⚖️", "description": "Combina clima, demanda, capacidad sanitaria y seguridad."},
    "Explorador": {"icon": "🧭", "description": "Reduce el peso de popularidad y favorece señales de calidad del destino."},
    "Personalizado": {"icon": "✨", "description": "Permite ajustar manualmente todos los pesos del modelo."},
}
...
def get_destination_context(target_month: int | None = None) -> list[dict[str, Any]]:
...
def compute_scores(
    ...
    **_: Any,
    ...
    destinations = _knn_impute(get_destination_context(target_month=target_month), k=3)
